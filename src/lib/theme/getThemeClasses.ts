...
const themes: Record<string, ThemeClasses> = {
  dark: {
    pageBg:
      "min-h-screen bg-[#09090b] bg-[radial-gradient(circle_at_18%_16%,rgba(255,140,60,0.14),transparent_0%,transparent_24%),radial-gradient(circle_at_78%_76%,rgba(255,255,255,0.05),transparent_0%,transparent_28%),radial-gradient(circle_at_56%_34%,rgba(255,255,255,0.06),transparent_0%,transparent_20%),linear-gradient(180deg,#0d0d0f_0%,#09090b_100%)] bg-no-repeat text-white",
    sidebarBg:
      "bg-[#111111]/88 border-[#2b2b2b] backdrop-blur-2xl supports-[backdrop-filter]:bg-[#111111]/78",
    sidebarCard:
      "bg-white/[0.06] border border-white/[0.09] shadow-[0_10px_30px_rgba(0,0,0,0.28)] backdrop-blur-xl",
    card: "bg-white/[0.055] border border-white/[0.08] shadow-[0_14px_40px_rgba(0,0,0,0.32)] backdrop-blur-xl",
    cardSoft:
      "bg-white/[0.075] border border-white/[0.10] shadow-[0_10px_28px_rgba(0,0,0,0.24)] backdrop-blur-xl",
    ...
    buttonPrimary:
      "bg-white text-black hover:bg-[#ececec] shadow-[0_12px_28px_rgba(255,255,255,0.08)]",
    buttonSecondary:
    ...
    headerBg:
      "bg-[#141414]/74 border-[#2a2a2a] backdrop-blur-2xl supports-[backdrop-filter]:bg-[#141414]/62",
  },

  elegant: {
    pageBg:
      "min-h-screen bg-[#f4efe8] bg-[radial-gradient(circle_at_12%_10%,rgba(107,79,58,0.10),transparent_0%,transparent_24%),radial-gradient(circle_at_90%_12%,rgba(255,255,255,0.42),transparent_0%,transparent_26%),linear-gradient(180deg,#f7f1ea_0%,#f4efe8_42%,#efe7dd_100%)] bg-no-repeat text-[#2b211b]",
    sidebarBg: "bg-[#fffaf5]/84 border-[#e7d8c7] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/70 border border-white/60 shadow-[0_12px_30px_rgba(107,79,58,0.08)] backdrop-blur-xl",
    card: "bg-white/66 border border-white/58 shadow-[0_16px_36px_rgba(107,79,58,0.10)] backdrop-blur-xl",
    cardSoft:
      "bg-white/78 border border-white/65 shadow-[0_12px_26px_rgba(107,79,58,0.07)] backdrop-blur-xl",
    ...
    active:
      "bg-[#6b4f3a] text-white shadow-[0_12px_28px_rgba(107,79,58,0.18)]",
    accent:
      "bg-[#6b4f3a] text-white shadow-[0_12px_28px_rgba(107,79,58,0.18)]",
    softAccent:
      "bg-[#efe4d7] text-[#5e4635] border border-[#dec9b3]",
    buttonPrimary:
      "bg-[#6b4f3a] text-white hover:bg-[#5f4734] shadow-[0_12px_26px_rgba(107,79,58,0.18)]",
    buttonSecondary:
    ...
    headerBg: "bg-[#f4efe8]/78 border-[#e6d8c7] backdrop-blur-2xl",
  },

  minimal: {
    pageBg:
      "min-h-screen bg-[#f8f8f8] bg-[radial-gradient(circle_at_90%_10%,rgba(0,0,0,0.03),transparent_0%,transparent_24%),linear-gradient(180deg,#fafafa_0%,#f7f7f7_45%,#f1f1f1_100%)] bg-no-repeat text-[#1f1f1f]",
    sidebarBg: "bg-white/86 border-[#e6e6e6] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/72 border border-white/62 shadow-[0_10px_24px_rgba(0,0,0,0.04)] backdrop-blur-xl",
    card: "bg-white/76 border border-white/62 shadow-[0_14px_30px_rgba(0,0,0,0.05)] backdrop-blur-xl",
    cardSoft:
      "bg-white/88 border border-white/68 shadow-[0_10px_22px_rgba(0,0,0,0.04)] backdrop-blur-xl",
    ...
    active:
      "bg-[#111111] text-white shadow-[0_10px_24px_rgba(17,17,17,0.18)]",
    accent:
      "bg-[#111111] text-white shadow-[0_10px_24px_rgba(17,17,17,0.18)]",
    softAccent: "bg-[#f1f1f1] text-[#444444] border border-[#dfdfdf]",
    buttonPrimary:
      "bg-[#111111] text-white hover:bg-[#222222] shadow-[0_12px_26px_rgba(17,17,17,0.15)]",
    buttonSecondary:
  ...
  rose_glam: {
    pageBg:
      "min-h-screen bg-[#0d0710] bg-[radial-gradient(circle_at_18%_20%,rgba(255,79,163,0.22),transparent_0%,transparent_28%),radial-gradient(circle_at_80%_78%,rgba(168,85,247,0.18),transparent_0%,transparent_30%),radial-gradient(circle_at_52%_34%,rgba(255,255,255,0.08),transparent_0%,transparent_18%),linear-gradient(180deg,#120b12_0%,#0d0710_100%)] bg-no-repeat text-white",
    sidebarBg: "bg-[#140f17]/86 border-[#352339] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/[0.075] border border-white/[0.11] shadow-[0_12px_30px_rgba(0,0,0,0.30)] backdrop-blur-xl",
    card: "bg-white/[0.075] border border-white/[0.11] shadow-[0_16px_40px_rgba(0,0,0,0.34)] backdrop-blur-xl",
    cardSoft:
      "bg-white/[0.095] border border-white/[0.13] shadow-[0_12px_28px_rgba(0,0,0,0.25)] backdrop-blur-xl",
    ...
    active:
      "bg-[#ff4fa3] text-white shadow-[0_14px_30px_rgba(255,79,163,0.24)]",
    accent:
      "bg-[#ff4fa3] text-white shadow-[0_14px_30px_rgba(255,79,163,0.24)]",
    softAccent:
      "bg-[#ff4fa3]/15 text-[#ffc0de] border border-[#ff4fa3]/30",
    buttonPrimary:
      "bg-[#ff4fa3] text-white hover:bg-[#f03f95] shadow-[0_14px_30px_rgba(255,79,163,0.24)]",
    buttonSecondary:
  ...
  sunset_pop: {
    pageBg:
      "min-h-screen bg-[#080708] bg-[radial-gradient(circle_at_18%_18%,rgba(255,122,0,0.22),transparent_0%,transparent_28%),radial-gradient(circle_at_78%_78%,rgba(255,84,0,0.16),transparent_0%,transparent_30%),radial-gradient(circle_at_52%_34%,rgba(255,244,237,0.06),transparent_0%,transparent_18%),linear-gradient(180deg,#100c0a_0%,#080708_100%)] bg-no-repeat text-white",
    sidebarBg: "bg-[#111216]/86 border-[#2d2b2a] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/[0.065] border border-white/[0.10] shadow-[0_12px_28px_rgba(0,0,0,0.30)] backdrop-blur-xl",
    card: "bg-white/[0.065] border border-white/[0.10] shadow-[0_16px_38px_rgba(0,0,0,0.34)] backdrop-blur-xl",
    cardSoft:
      "bg-white/[0.09] border border-white/[0.12] shadow-[0_12px_26px_rgba(0,0,0,0.25)] backdrop-blur-xl",
    ...
    hover: "hover:bg-white/[0.12]",
    active:
      "bg-[#ff7a00] text-white shadow-[0_14px_30px_rgba(255,122,0,0.24)]",
    accent:
      "bg-[#ff7a00] text-white shadow-[0_14px_30px_rgba(255,122,0,0.24)]",
    softAccent:
      "bg-[#ff7a00]/15 text-[#ffcfaa] border border-[#ff7a00]/30",
    buttonPrimary:
      "bg-[#ff7a00] text-white hover:bg-[#ec6f00] shadow-[0_14px_30px_rgba(255,122,0,0.22)]",
    buttonSecondary:
      "bg-white/[0.10] border border-white/[0.14] text-white hover:bg-white/[0.15]",
    logoutButton:
  ...
  violet_neon: {
    pageBg:
      "min-h-screen bg-[#060912] bg-[radial-gradient(circle_at_22%_18%,rgba(214,107,255,0.22),transparent_0%,transparent_28%),radial-gradient(circle_at_75%_80%,rgba(79,156,255,0.20),transparent_0%,transparent_30%),radial-gradient(circle_at_52%_36%,rgba(255,255,255,0.08),transparent_0%,transparent_18%),linear-gradient(180deg,#090d1a_0%,#060912_100%)] bg-no-repeat text-white",
    sidebarBg: "bg-[#11142a]/86 border-[#292e54] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/[0.075] border border-white/[0.11] shadow-[0_12px_30px_rgba(0,0,0,0.30)] backdrop-blur-xl",
    card: "bg-white/[0.075] border border-white/[0.11] shadow-[0_16px_40px_rgba(0,0,0,0.34)] backdrop-blur-xl",
    cardSoft:
      "bg-white/[0.095] border border-white/[0.13] shadow-[0_12px_28px_rgba(0,0,0,0.26)] backdrop-blur-xl",
    subtle: "bg-white/[0.055] border border-white/[0.10]",
    input:
      "bg-white/[0.10] border-white/[0.15] text-white placeholder:text-white/45 backdrop-blur-md focus:border-white/[0.22] focus:bg-white/[0.12]",
    ...
    hover: "hover:bg-white/[0.12]",
    active:
      "bg-[#8b5cf6] text-white shadow-[0_14px_30px_rgba(139,92,246,0.24)]",
    accent:
      "bg-[#8b5cf6] text-white shadow-[0_14px_30px_rgba(139,92,246,0.24)]",
    softAccent:
      "bg-[#8b5cf6]/15 text-[#d9ccff] border border-[#8b5cf6]/30",
    buttonPrimary:
      "bg-[#8b5cf6] text-white hover:bg-[#7c4df0] shadow-[0_14px_30px_rgba(139,92,246,0.24)]",
    buttonSecondary:
      "bg-white/[0.10] border border-white/[0.14] text-white hover:bg-white/[0.15]",
    logoutButton:
  ...
  aqua_lux: {
    pageBg:
      "min-h-screen bg-[#040b0d] bg-[radial-gradient(circle_at_18%_18%,rgba(0,207,213,0.18),transparent_0%,transparent_26%),radial-gradient(circle_at_78%_80%,rgba(40,196,147,0.16),transparent_0%,transparent_30%),radial-gradient(circle_at_54%_34%,rgba(255,255,255,0.07),transparent_0%,transparent_18%),linear-gradient(180deg,#071317_0%,#040b0d_100%)] bg-no-repeat text-white",
    ...
    hover: "hover:bg-white/[0.12]",
    active:
      "bg-[#00cfd5] text-black shadow-[0_14px_30px_rgba(0,207,213,0.24)]",
    accent:
      "bg-[#00cfd5] text-black shadow-[0_14px_30px_rgba(0,207,213,0.24)]",
    softAccent:
      "bg-[#00cfd5]/15 text-[#bdfcff] border border-[#00cfd5]/30",
    buttonPrimary:
      "bg-[#00cfd5] text-black hover:bg-[#00bac0] shadow-[0_14px_30px_rgba(0,207,213,0.24)]",
    buttonSecondary:
      "bg-white/[0.10] border border-white/[0.14] text-white hover:bg-white/[0.15]",
    logoutButton:
  ...
  ruby_night: {
    pageBg:
      "min-h-screen bg-[#080407] bg-[radial-gradient(circle_at_18%_18%,rgba(225,29,72,0.18),transparent_0%,transparent_26%),radial-gradient(circle_at_80%_80%,rgba(190,24,93,0.15),transparent_0%,transparent_30%),radial-gradient(circle_at_52%_34%,rgba(255,255,255,0.06),transparent_0%,transparent_18%),linear-gradient(180deg,#12080d_0%,#080407_100%)] bg-no-repeat text-white",
    ...
    hover: "hover:bg-white/[0.12]",
    active:
      "bg-[#e11d48] text-white shadow-[0_14px_30px_rgba(225,29,72,0.24)]",
    accent:
      "bg-[#e11d48] text-white shadow-[0_14px_30px_rgba(225,29,72,0.24)]",
    softAccent:
      "bg-[#e11d48]/15 text-[#ffc3d0] border border-[#e11d48]/30",
    buttonPrimary:
      "bg-[#e11d48] text-white hover:bg-[#cf1a43] shadow-[0_14px_30px_rgba(225,29,72,0.22)]",
    buttonSecondary:
      "bg-white/[0.10] border border-white/[0.14] text-white hover:bg-white/[0.15]",
    logoutButton:
  ...
  blush_pop: {
    pageBg:
      "min-h-screen bg-[#fff1f6] bg-[radial-gradient(circle_at_12%_10%,rgba(236,95,149,0.12),transparent_0%,transparent_24%),radial-gradient(circle_at_88%_14%,rgba(255,255,255,0.42),transparent_0%,transparent_28%),linear-gradient(180deg,#fff4f8_0%,#fff1f6_42%,#fde8ef_100%)] bg-no-repeat text-[#4a2333]",
    sidebarBg: "bg-[#fff8fb]/84 border-[#f3cddd] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/74 border border-white/62 shadow-[0_12px_30px_rgba(236,95,149,0.08)] backdrop-blur-xl",
    card: "bg-white/70 border border-white/60 shadow-[0_16px_36px_rgba(236,95,149,0.10)] backdrop-blur-xl",
    cardSoft:
      "bg-white/82 border border-white/66 shadow-[0_12px_26px_rgba(236,95,149,0.07)] backdrop-blur-xl",
    ...
    active:
      "bg-[#ec5f95] text-white shadow-[0_12px_28px_rgba(236,95,149,0.18)]",
    accent:
      "bg-[#ec5f95] text-white shadow-[0_12px_28px_rgba(236,95,149,0.18)]",
    softAccent: "bg-[#fbd4e3] text-[#9e3c63] border border-[#f2b7cc]",
    buttonPrimary:
      "bg-[#ec5f95] text-white hover:bg-[#dd4f86] shadow-[0_12px_28px_rgba(236,95,149,0.18)]",
    buttonSecondary:
  ...
  cotton_candy: {
    pageBg:
      "min-h-screen bg-[#fdf4ff] bg-[radial-gradient(circle_at_12%_10%,rgba(214,107,255,0.12),transparent_0%,transparent_24%),radial-gradient(circle_at_88%_14%,rgba(255,255,255,0.42),transparent_0%,transparent_28%),linear-gradient(180deg,#fef7ff_0%,#fdf4ff_44%,#f7e9fb_100%)] bg-no-repeat text-[#44275a]",
    sidebarBg: "bg-[#fff9ff]/84 border-[#ebd3f7] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/74 border border-white/62 shadow-[0_12px_30px_rgba(214,107,255,0.08)] backdrop-blur-xl",
    card: "bg-white/70 border border-white/60 shadow-[0_16px_36px_rgba(214,107,255,0.10)] backdrop-blur-xl",
    cardSoft:
      "bg-white/82 border border-white/66 shadow-[0_12px_26px_rgba(214,107,255,0.07)] backdrop-blur-xl",
    ...
    active:
      "bg-[#d66bff] text-white shadow-[0_12px_28px_rgba(214,107,255,0.18)]",
    accent:
      "bg-[#d66bff] text-white shadow-[0_12px_28px_rgba(214,107,255,0.18)]",
    softAccent: "bg-[#f1d8ff] text-[#8b3eb1] border border-[#e4b8fb]",
    buttonPrimary:
      "bg-[#d66bff] text-white hover:bg-[#c85af5] shadow-[0_12px_28px_rgba(214,107,255,0.18)]",
    buttonSecondary:
  ...
  pearl_rose: {
    pageBg:
      "min-h-screen bg-[#fff7f8] bg-[radial-gradient(circle_at_12%_10%,rgba(204,127,149,0.10),transparent_0%,transparent_22%),radial-gradient(circle_at_88%_14%,rgba(255,255,255,0.45),transparent_0%,transparent_28%),linear-gradient(180deg,#fffafa_0%,#fff7f8_44%,#fbecef_100%)] bg-no-repeat text-[#3f2a2f]",
    sidebarBg: "bg-[#fffdfd]/84 border-[#ecd8dc] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/76 border border-white/64 shadow-[0_12px_28px_rgba(155,90,105,0.07)] backdrop-blur-xl",
    card: "bg-white/72 border border-white/60 shadow-[0_16px_34px_rgba(155,90,105,0.09)] backdrop-blur-xl",
    cardSoft:
      "bg-white/86 border border-white/68 shadow-[0_12px_24px_rgba(155,90,105,0.06)] backdrop-blur-xl",
    ...
    active:
      "bg-[#cc7f95] text-white shadow-[0_12px_28px_rgba(204,127,149,0.16)]",
    accent:
      "bg-[#cc7f95] text-white shadow-[0_12px_28px_rgba(204,127,149,0.16)]",
    softAccent: "bg-[#f5dde4] text-[#8e5364] border border-[#e7bec9]",
    buttonPrimary:
      "bg-[#cc7f95] text-white hover:bg-[#be7187] shadow-[0_12px_28px_rgba(204,127,149,0.16)]",
    buttonSecondary:
  ...
  mint_day: {
    pageBg:
      "min-h-screen bg-[#eefcf7] bg-[radial-gradient(circle_at_12%_10%,rgba(40,196,147,0.10),transparent_0%,transparent_22%),radial-gradient(circle_at_88%_14%,rgba(255,255,255,0.44),transparent_0%,transparent_28%),linear-gradient(180deg,#f5fffb_0%,#eefcf7_44%,#e4f7ef_100%)] bg-no-repeat text-[#1f3d35]",
    sidebarBg: "bg-[#f8fffc]/84 border-[#cfeadf] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/76 border border-white/62 shadow-[0_12px_28px_rgba(40,196,147,0.07)] backdrop-blur-xl",
    card: "bg-white/72 border border-white/60 shadow-[0_16px_34px_rgba(40,196,147,0.09)] backdrop-blur-xl",
    cardSoft:
      "bg-white/84 border border-white/66 shadow-[0_12px_24px_rgba(40,196,147,0.06)] backdrop-blur-xl",
    ...
    active:
      "bg-[#28c493] text-white shadow-[0_12px_28px_rgba(40,196,147,0.18)]",
    accent:
      "bg-[#28c493] text-white shadow-[0_12px_28px_rgba(40,196,147,0.18)]",
    softAccent: "bg-[#cff4e6] text-[#1f7f62] border border-[#afe5d2]",
    buttonPrimary:
      "bg-[#28c493] text-white hover:bg-[#22b286] shadow-[0_12px_28px_rgba(40,196,147,0.18)]",
    buttonSecondary:
  ...
  sky_breeze: {
    pageBg:
      "min-h-screen bg-[#f1f8ff] bg-[radial-gradient(circle_at_12%_10%,rgba(79,156,255,0.10),transparent_0%,transparent_22%),radial-gradient(circle_at_88%_14%,rgba(255,255,255,0.44),transparent_0%,transparent_28%),linear-gradient(180deg,#f8fcff_0%,#f1f8ff_44%,#e7f2fc_100%)] bg-no-repeat text-[#20364f]",
    sidebarBg: "bg-[#f9fcff]/84 border-[#cfe1f4] backdrop-blur-2xl",
    sidebarCard:
      "bg-white/76 border border-white/62 shadow-[0_12px_28px_rgba(79,156,255,0.07)] backdrop-blur-xl",
    card: "bg-white/72 border border-white/60 shadow-[0_16px_34px_rgba(79,156,255,0.09)] backdrop-blur-xl",
    cardSoft:
      "bg-white/84 border border-white/66 shadow-[0_12px_24px_rgba(79,156,255,0.06)] backdrop-blur-xl",
    ...
    active:
      "bg-[#4f9cff] text-white shadow-[0_12px_28px_rgba(79,156,255,0.18)]",
    accent:
      "bg-[#4f9cff] text-white shadow-[0_12px_28px_rgba(79,156,255,0.18)]",
    softAccent: "bg-[#d8eaff] text-[#3069b8] border border-[#bdd8ff]",
    buttonPrimary:
      "bg-[#4f9cff] text-white hover:bg-[#418ff5] shadow-[0_12px_28px_rgba(79,156,255,0.18)]",
    buttonSecondary:
  ...
  warm: {
    ...
    sidebarCard:
      "bg-white/72 border border-white/58 shadow-[0_12px_30px_rgba(165,106,58,0.08)] backdrop-blur-xl",
    card: "bg-white/66 border border-white/56 shadow-[0_16px_38px_rgba(165,106,58,0.10)] backdrop-blur-xl",
    cardSoft:
      "bg-white/78 border border-white/62 shadow-[0_12px_26px_rgba(165,106,58,0.07)] backdrop-blur-xl",
    ...
    active:
      "bg-[#a56a3a] text-white shadow-[0_12px_28px_rgba(165,106,58,0.18)]",
    accent:
      "bg-[#a56a3a] text-white shadow-[0_12px_28px_rgba(165,106,58,0.18)]",
    softAccent: "bg-[#f1e5d7] text-[#6b4f3a] border border-[#e0c8b0]",
    buttonPrimary:
      "bg-[#a56a3a] text-white hover:bg-[#8d582e] shadow-[0_12px_28px_rgba(165,106,58,0.18)]",
    buttonSecondary:
