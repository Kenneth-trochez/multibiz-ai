...
export const metadata = {
  title: "Software para Salones de Belleza | MultiBiz AI",
  description:
    "Sistema para Salones de Belleza con gestión de citas, clientes, servicios, ventas, balance y recordatorios desde app móvil.",
  keywords: [
    "software para Salones de Belleza",
    "sistema de citas para Salones de Belleza",
...
export default function BarberiasPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Administra cortes, alisados, queratinas, precios, duración y staff disponible.",
    },
    {
      icon: BellRing,
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <section className={`rounded-[2rem] border p-6 shadow-xl md:p-10 ${theme.glassCard}`}>
          <div className="max-w-3xl">
            <div className={`mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-bold ${theme.softAccent}`}>
              ...
              Solución para Salones de Belleza
            </div>

            <h1 className="text-4xl font-black tracking-tight sm:text-5xl">
              Software para Salones de Belleza con citas, clientes y control de ingresos.
            </h1>

            <p className={`mt-5 text-base leading-7 ${theme.textMuted}`}>
              MultiBiz AI ayuda a Salones de Belleza a organizar su agenda, administrar
        ...
        <section className={`mt-8 rounded-[2rem] border p-6 md:p-8 ${theme.glassCard}`}>
          <h2 className="text-2xl font-black">
            ¿Por qué una barbería debería usar MultiBiz AI?
          </h2>
