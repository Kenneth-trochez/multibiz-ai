...
export const metadata = {
  ...
  description:
    "Sistema para salones de belleza con gestión de citas, clientes, servicios y control de ingresos desde web y app móvil.",
};
    ...
    <main className={`min-h-screen px-4 py-10 ${theme.pageBg}`}>
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="text-4xl font-black">
          Software para salones de belleza con gestión completa
        </h1>
