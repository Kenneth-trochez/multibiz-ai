...
export const metadata = {
  title: "Software para talleres mecanicos | MultiBiz AI",
  description:
    "Administra clientes servicios y trabajos en talleres mecanicos",
};
    ...
    <main className={`min-h-screen px-4 py-10 ${theme.pageBg}`}>
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="text-4xl font-black">
          Software para Talleres mecanicos con ordenes de trabajo, reparacion de vehiculos, ygestion completa
        </h1>
