...
export const metadata = {
  title: "Software para talleres | MultiBiz AI",
  description:
    "Sistema para barberías con gestión de citas, clientes, servicios, ventas, balance y recordatorios desde app móvil.",
  keywords: [
    "software para talleres",
    "sistema de citas para talleres",
    "app para talleres",
    "gestión de talleres",
...
export default function BarberiasPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Administra agendas como cambios de aceite, mantenimineto, precios, duración y staff disponible.",
    },
    {
      icon: BellRing,
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <section className={`rounded-[2rem] border p-6 shadow-xl md:p-10 ${theme.glassCard}`}>
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl font-black tracking-tight sm:text-5xl">
              Software para Talleres con citas, clientes y control de ingresos.
            </h1>

            <p className={`mt-5 text-base leading-7 ${theme.textMuted}`}>
              MultiBiz AI ayuda a Talleres a organizar su agenda, administrar
        ...
        <section className={`mt-8 rounded-[2rem] border p-6 md:p-8 ${theme.glassCard}`}>
          <h2 className="text-2xl font-black">
            ¿Por qué un taller debería usar MultiBiz AI?
          </h2>
