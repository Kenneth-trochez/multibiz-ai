...
export const metadata = {
  title: "Software para barberías | MultiBiz AI",
  description:
...
export default function BarberiasPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Administra cortes, barba, precios, duración y staff disponible.",
    },
    {
      icon: BellRing,
        ...
        <section className={`rounded-[2rem] border p-6 shadow-xl md:p-10 ${theme.glassCard}`}>
          <div className="max-w-3xl">
            <div className={`mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-bold ${theme.softAccent}`}>
              ...
              Solución para barberías
            </div>

            <h1 className="text-4xl font-black tracking-tight sm:text-5xl">
              Software para barberías con citas, clientes y control de ingresos.
            </h1>

            <p className={`mt-5 text-base leading-7 ${theme.textMuted}`}>
              MultiBiz AI ayuda a barberías a organizar su agenda, administrar
