...
export const metadata = {
  title: "Software para Clinicas | MultiBiz AI",
  description:
    "Sistema para Clinicas con gestión de citas, clientes, servicios, ventas, balance y recordatorios desde app móvil.",
  keywords: [
    "software para Clinicas",
    "sistema de citas para Clinicas",
    "app para Clinicas",
    "gestión de Clinicas",
    "agenda para Clinicas",
    "MultiBiz AI",
  ],
};
...
export default function BarberiasPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Administra consultas generales, internaciones, precios, duración y staff disponible.",
    },
    {
      icon: BellRing,
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <section className={`rounded-[2rem] border p-6 shadow-xl md:p-10 ${theme.glassCard}`}>
          <div className="max-w-3xl">
            <div className={`mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-bold ${theme.softAccent}`}>
              ...
              Solución para Clinicas
            </div>

            <h1 className="text-4xl font-black tracking-tight sm:text-5xl">
              Software para Clinicas con citas, clientes y control de ingresos.
            </h1>

            <p className={`mt-5 text-base leading-7 ${theme.textMuted}`}>
              MultiBiz AI ayuda a Clinicas a organizar su agenda, administrar
        ...
        <section className={`mt-8 rounded-[2rem] border p-6 md:p-8 ${theme.glassCard}`}>
          <h2 className="text-2xl font-black">
            ¿Por qué una Clinica debería usar MultiBiz AI?
          </h2>
