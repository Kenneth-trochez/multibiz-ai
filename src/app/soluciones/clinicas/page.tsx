...
export const metadata = {
  title: "Sistema de citas para clinicas | MultiBiz AI",
  description:
    "Gestiona citas medicas, pacientes y personal con MultiBiz AI",
};
    ...
    <main className={`min-h-screen px-4 py-10 ${theme.pageBg}`}>
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="text-4xl font-black">
          Software para clinicas Medicas con gestión completa
        </h1>
